...
def endpoints():
    ...
    out = dijkstra.pretty_path(path[0], stops_dict, routes_dict)

    result_win = tk.Toplevel(root)
    result_win.title("Útvonal")
    result_win.configure(bg="white")

    header = tk.Label(result_win, text="Tervezett útvonal", 
                  font=("Courier", 16, "bold"), bg="purple", fg="white")
    header.pack(fill="x", pady=(0,10))

    textbox = tk.Text(result_win, font=("Courier", 12), fg="purple", 
